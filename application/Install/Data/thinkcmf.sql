...
CREATE TABLE IF NOT EXISTS `ly_ad` (
...
CREATE TABLE IF NOT EXISTS `ly_asset` (
...
CREATE TABLE IF NOT EXISTS `ly_auth_access` (
...
INSERT INTO `ly_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
CREATE TABLE IF NOT EXISTS `ly_comments` (
...
--
-- 表的结构 `ly_common_action_log`
--

CREATE TABLE IF NOT EXISTS `ly_common_action_log` (
...
CREATE TABLE IF NOT EXISTS `ly_links` (
...
INSERT INTO `ly_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
(1, 'http://www.hkorion.com', 'Orion', '', '_self', '', 1, 0, '', 0);
...
INSERT INTO `ly_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `ly_nav` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='前台导航表' AUTO_INCREMENT=15 ;

--
-- 转存表中的数据 `ly_nav`
--

INSERT INTO `ly_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
(1, 1, 0, 'Home', '', 'home', '', 1, 0, '0-1'),
(2, 1, 0, '列表演示', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"1";}}', '', 0, 0, '0-2'),
(3, 1, 0, '瀑布流', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"2";}}', '', 0, 0, '0-3'),
(4, 1, 0, 'About  us', '', 'a:2:{s:6:"action";s:17:"Portal/Page/index";s:5:"param";a:1:{s:2:"id";s:1:"1";}}', '', 1, 0, '0-4'),
(5, 1, 0, 'Products', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"3";}}', '', 1, 0, '0-5'),
(6, 1, 0, 'Contact  us', '', 'a:2:{s:6:"action";s:17:"Portal/Page/index";s:5:"param";a:1:{s:2:"id";s:1:"2";}}', '', 1, 0, '0-6'),
(7, 1, 0, 'Online  Message', '', 'a:2:{s:6:"action";s:17:"Portal/Page/index";s:5:"param";a:1:{s:2:"id";s:1:"3";}}', '', 1, 0, '0-7'),
(8, 1, 5, 'p1', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"4";}}', '', 1, 0, '0-5-8'),
(9, 1, 5, 'p2', '', 'home', '', 1, 0, '0-5-9'),
(10, 1, 8, 'p12', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"7";}}', '', 1, 0, '0-5-8-10'),
(11, 1, 8, 'jkghaksgkhajkfkjassghd', '', 'home', '', 1, 0, '0-5-8-11'),
(12, 1, 8, 'hhhhhhhhhhhhhhhhhhhjkk', '', 'home', '', 1, 0, '0-5-8-12'),
(13, 1, 5, 'aaaaaaaaaaaaaaaaaaa', '', 'home', '', 1, 0, '0-5-13'),
(14, 1, 9, '22222222222222', '', 'home', '', 1, 0, '0-5-9-14');
...
CREATE TABLE IF NOT EXISTS `ly_nav_cat` (
...
INSERT INTO `ly_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `ly_oauth_user` (
...
CREATE TABLE IF NOT EXISTS `ly_options` (
...
INSERT INTO `ly_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
...
(2, 'site_options', '{"site_name":"ORION WEB","site_host":"http:\\/\\/www.hkorion.com\\/","site_admin_url_password":"","site_tpl":"laoyao","mobile_tpl_enabled":"1","site_adminstyle":"bluesky","site_icp":"","site_admin_email":"hkorion@sina.com","site_tongji":"","site_copyright":"","site_seo_title":"ORION WEB","site_seo_keywords":"ORION","site_seo_description":"ORION","urlmode":"1","html_suffix":"","comment_time_interval":60}', 1),
...
CREATE TABLE IF NOT EXISTS `ly_plugins` (
...
CREATE TABLE IF NOT EXISTS `ly_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Portal文章表' AUTO_INCREMENT=10 ;

--
-- 转存表中的数据 `ly_posts`
--

INSERT INTO `ly_posts` (`id`, `post_author`, `post_keywords`, `post_source`, `post_date`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `post_modified`, `post_content_filtered`, `post_parent`, `post_type`, `post_mime_type`, `comment_count`, `smeta`, `post_hits`, `post_like`, `istop`, `recommended`) VALUES
(1, 1, ' About us ', NULL, '2016-04-22 11:20:27', '<p style="text-align: left; margin-top: 10px; line-height: 1.75em; text-indent: 2em;"><span style="color: rgb(63, 63, 63); font-family: arial, helvetica, sans-serif; font-size: 16px;">Orion Industry and Trade Co. Ltd was founded in 2012 and our head office is in Jinjiang Quanzhou City, Fujian Province in People<span style="font-family: arial, helvetica, sans-serif; color: rgb(63, 63, 63);">’s Republic of China. Our company is a factory and trading company. Since the beginning, we produce and sell a large broad assortment of different bags categories ranging from leisure, fashion, business, travel, school, junior, baby, kids, outdoor, mountain and tool bags.</span><br style="text-align: left;"/>As our company<span style="font-family: arial, helvetica, sans-serif; color: rgb(63, 63, 63);">’s motto “Quality first, Customer foremost”, we continue to offer the finest quality products at competitive prices, backed by the best quality control at every step from design department, production workshop, selling sector, export and aftersale services of team of more than 150 staffs and workers operating in in large space area of 350,000 m2 of industrial production plant of 10 processing lines with an annual turnover of 200,000,000 yuan. Since three years, our products are on on this eCommerce website.</span><br style="text-align: left;"/>&nbsp;Our main customers are from North America, Europe, Asia, South America, and Africa where the OEM and ODM are both welcome.</span></p><p><br style="text-align: left;"/></p>', ' About us ', ' About us ', 1, 1, '2016-04-22 11:19:32', NULL, 0, 2, '', 0, '{"template":"page","thumb":""}', 0, 0, 0, 0),
(2, 1, 'Contact us ', NULL, '2016-04-22 11:21:12', '<p>Contact us&nbsp;</p>', 'Contact us ', 'Contact us ', 1, 1, '2016-04-22 11:20:31', NULL, 0, 2, '', 0, '{"template":"page","thumb":""}', 0, 0, 0, 0),
(3, 1, 'Online Message', NULL, '2016-04-22 11:21:50', '<p>Online Message</p>', 'Online Message', 'Online Message', 1, 1, '2016-04-22 11:21:17', NULL, 0, 2, '', 0, '{"template":"contact","thumb":""}', 0, 0, 0, 0),
(4, 1, '111', '1111', '2016-04-22 17:05:31', '<p>11111111111111111111111111111111111111111111111111111111111111111111111111111111</p>', '111', '11111111111111111111111111111111111111111111111111111111111111111111111111111111', 1, 1, '2016-04-22 17:04:57', NULL, 0, NULL, '', 0, '{"thumb":"20160422\\/5719e9537a1f6.jpg"}', 9, 0, 0, 0),
(5, 1, 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', '2016-04-22 17:06:17', '<p>sadasdasdsadsdsdsadsadsadasddas</p>', 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', 1, 1, '2016-04-22 17:05:35', NULL, 0, NULL, '', 0, '{"thumb":"20160422\\/5719e984d942c.gif"}', 32, 0, 0, 0),
(6, 1, 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', '2016-04-22 17:06:37', '<p>sadasdasdsadsdsdsadsadsadasddas</p>', 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', 1, 1, '2016-04-22 17:06:22', NULL, 0, NULL, '', 0, '{"thumb":"20160422\\/5719e99953620.gif"}', 28, 0, 0, 0),
(7, 1, 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', '2016-04-22 17:07:09', '<p>sadasdasdsadsdsdsadsadsadasddas</p>', 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', 1, 1, '2016-04-22 17:06:41', NULL, 0, NULL, '', 0, '{"thumb":"20160422\\/5719e9ac2d801.gif"}', 14, 0, 0, 0),
(8, 1, 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', '2016-04-22 17:07:27', '<p>sadasdasdsadsdsdsadsadsadasddas</p>', 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', 1, 1, '2016-04-22 17:07:13', NULL, 0, NULL, '', 0, '{"thumb":"20160422\\/5719e9cb477d7.gif"}', 49, 0, 0, 0),
(9, 1, 'sadasdasdsadsdsdsadsadsadasddas', 'sadasdasdsadsdsdsadsadsadasddas', '2016-04-22 17:07:46', '<p>There are moments in life when you miss someone so much that you just want to pick them from your dreams and hug them for real! Dream what you want to dream;go where you want to go;be what you want to be,because you have only one life and one chance to do all the things you want to do.</p>', 'There are moments in life when you miss someone so much that you just', 'There are moments in life when you miss someone so much that you just want to pick them from your dreams and hug them for real! Dream what you want to dream;go where you want to go;be what you want to be,because you have only one life and one chance to do all the things you want to do.', 1, 1, '2016-04-22 17:07:30', NULL, 0, NULL, '', 0, '{"thumb":"20160422\\/5719e9dc26324.gif","photo":[{"url":"20160426\\/571eb8bf0da3d.jpg","alt":"Downhill-Mountain-Biking"},{"url":"20160426\\/571eb8c1cb4a1.jpg","alt":"hiking"},{"url":"20160426\\/571ebfc722e9f.png","alt":"112233"},{"url":"20160426\\/571ebfcb84607.jpg","alt":"Downhill-Mountain-Biking"},{"url":"20160426\\/571ebfcdea6db.jpg","alt":"walking-to-school-three-boys-backpacks-book-bags-home-sidewalk-58520231"},{"url":"20160426\\/571ebff700f33.jpg","alt":"101"},{"url":"20160426\\/571ebff872d15.jpg","alt":"walking-to-school-three-boys-backpacks-book-bags-home-sidewalk-58520231"}]}', 88, 0, 0, 0);
...
INSERT INTO `ly_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `ly_route` (
...
CREATE TABLE IF NOT EXISTS `ly_slide` (
...
INSERT INTO `ly_slide` (`slide_id`, `slide_cid`, `slide_name`, `slide_pic`, `slide_url`, `slide_des`, `slide_content`, `slide_status`, `listorder`) VALUES
(1, 1, '01', '/data/upload/20160422/571996dd97b5f.jpg', '', '', '', 1, 0),
(2, 1, '02', '/data/upload/20160422/571996f68287b.jpg', '', '', '', 1, 0),
(3, 1, '03', '/data/upload/20160422/5719970b3996f.jpg', '', '', '', 1, 0),
(4, 2, '1', '/data/upload/20160423/571b187a22748.jpg', '', '', '', 1, 0),
(5, 3, '2', '/data/upload/20160423/571b1e7fbf118.jpg', '', '', '', 1, 0),
(6, 4, '1', '/data/upload/20160425/571dcabd76131.jpg', '', '', '', 1, 0);
...
CREATE TABLE IF NOT EXISTS `ly_slide_cat` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='幻灯片分类表' AUTO_INCREMENT=5 ;

--
-- 转存表中的数据 `ly_slide_cat`
--

INSERT INTO `ly_slide_cat` (`cid`, `cat_name`, `cat_idname`, `cat_remark`, `cat_status`) VALUES
(1, '首页全屏轮播图', 'index_slider', '首页全屏轮播图1170*500', 1),
(2, '关于我们顶图', 'aboutus_ads', '关于我们顶图(1150*350)', 1),
(3, '联系我们顶图', 'contactus_ads', '联系我们顶图（1150*350）', 1),
(4, '产品列表广告位', 'products_ads', '产品列表广告位（1150*350）', 1);
...
CREATE TABLE IF NOT EXISTS `ly_terms` (
  ...
  PRIMARY KEY (`term_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类表' AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `ly_terms`
--

INSERT INTO `ly_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
(1, '列表演示', '', 'article', '', 0, 0, '0-1', '', '', '', 'list', 'article', 0, 1),
(2, '瀑布流', '', 'article', '', 0, 0, '0-2', '', '', '', 'list_masonry', 'article', 0, 1),
(3, ' Products ', '', 'picture', ' Products ', 0, 0, '0-3', '', '', '', 'list_masonry', 'article', 0, 1),
(4, 'P1', '', 'picture', '', 3, 0, '0-3-4', '', '', '', 'list_masonry', 'article', 0, 1),
(5, 'P2', '', 'picture', '', 3, 0, '0-3-5', '', '', '', 'list_masonry', 'article', 0, 1),
(6, 'AAAAAAAAAA', '', 'picture', '', 3, 0, '0-3-6', '', '', '', 'list_masonry', 'article', 0, 1),
(7, 'P12', '', 'picture', '', 4, 0, '0-3-4-7', '', '', '', 'list_masonry', 'article', 0, 1),
(8, 'test', '', 'article', '', 5, 0, '0-3-5-8', '', '', '', 'list', 'article', 0, 1);

-- --------------------------------------------------------

--
-- 表的结构 `ly_term_relationships`
--

CREATE TABLE IF NOT EXISTS `ly_term_relationships` (
...
--
-- 转存表中的数据 `ly_term_relationships`
--

INSERT INTO `ly_term_relationships` (`tid`, `object_id`, `term_id`, `listorder`, `status`) VALUES
(1, 4, 3, 0, 1),
(2, 5, 3, 0, 1),
(3, 6, 3, 0, 1),
(4, 7, 3, 0, 1),
...
CREATE TABLE IF NOT EXISTS `ly_users` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `ly_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
(1, 'orion', '###c03068bbd6bd4fc611246eca1acfa910', 'admin', 'hkorion@sina.com', '', NULL, 0, NULL, NULL, '59.61.238.133', '2016-04-26 08:26:06', '2016-04-21 08:37:28', '', 1, 0, 1, 0, '');

-- --------------------------------------------------------

--
-- 表的结构 `ly_user_favorites`
--

CREATE TABLE IF NOT EXISTS `ly_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
